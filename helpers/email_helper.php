...
function email()
{
    ...
    if (isset($_POST["submit"])) {
        ...
        $from = 'contact@hansenhistory.adambailey.io';
        $to = 'adamjbailey7@gmail.com'; // Enter email address to send emails TO here
        $subject = 'Message from Hansen History Contact Form'; //What goes in the subject line of your email here
